...
\begin{alertblock}{Current Status \& Outlook}
  \begin{center}
    \includegraphics[width=0.3\linewidth]{IMG_8024.png}\hspace{6cm}
    \includegraphics[width=0.242\linewidth]{IMG_8028.png} \\[4pt]
    \captionof{figure}{\small Side views of the assembled XTRACT system mounted on the aluminum support frame.}
  \end{center}
